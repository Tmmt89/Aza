...
⚠️ **Второй источник — `laamxo/dosham`** (классические словари: Мациев,
Байсултанов, Исмаилов, анатомический терминологический; только ce→ru
направление, 5 904 заголовочных слова, boost ×3): явной лицензии в
репозитории НЕТ. Слова используются для расширения словаря; перед релизом
рекомендуется связаться с автором компиляции и добавить атрибуцию всех
десяти исходных словарей в THIRD_PARTY.
